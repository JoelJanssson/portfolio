            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
                ...
                <div className="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        <div className="bg-steel-blue-tint text-l font-semibold p-4 rounded-lg shadow text-center text-dark-navy">SCRUM</div>
                        <div className="bg-steel-blue-tint text-l font-semibold p-4 rounded-lg shadow text-center text-dark-navy">HTML 5</div>
                        <div className="bg-steel-blue-tint text-l font-semibold p-4 rounded-lg shadow text-center text-dark-navy">CSS 3</div>
                ...
                <div className="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                        <div className="bg-steel-blue-tint p-4 rounded-lg shadow flex justify-between">
                            ...
                            <p className="text-xl text-dark-navy">Native</p>
                        </div>
                        <div className="bg-steel-blue-tint p-4 rounded-lg shadow flex justify-between">
